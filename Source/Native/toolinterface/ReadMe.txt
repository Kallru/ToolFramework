========================================================================
    동적 라이브러리 연결: ToolInterface 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 ToolInterface DLL을 만들었습니다.

이 파일에는 ToolInterface 응용 프로그램을  구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.


ToolInterface.vcproj
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일인 ToolInterface.pch와
